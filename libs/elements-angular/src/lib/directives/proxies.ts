...
@ProxyCmp({
  inputs: ['baseUrl', 'disabled', 'language', 'localizeCode', 'name', 'options', 'originalValue', 'uri', 'value'],
  methods: ['format', 'action']
})
@Component({
  selector: 'aiao-code-diff-editor',
...
@ProxyCmp({
  inputs: ['baseUrl', 'disabled', 'language', 'localizeCode', 'name', 'options', 'uri', 'value'],
  methods: ['format', 'action']
})
@Component({
  selector: 'aiao-code-editor',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['baseUrl', 'disabled', 'language', 'localizeCode', 'name', 'options', 'uri', 'value']
})
...
@Component({
  selector: 'aiao-elements-editor',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['config', 'disabled', 'editMode', 'name', 'value', 'view']
})
...
@Component({
  selector: 'aiao-elements-preview',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['config', 'editMode', 'value']
})
...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['alt', 'animation', 'map', 'method', 'platform', 'src']
})
...
@ProxyCmp({
  inputs: ['defaultParagraphSeparator', 'disabled', 'element', 'name', 'showActionBar', 'value'],
  methods: ['getSelectionElements', 'saveSelection', 'restoreSelection', 'action']
})
@Component({
  selector: 'aiao-text-editor',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['defaultParagraphSeparator', 'disabled', 'element', 'name', 'showActionBar', 'value']
})
...
@ProxyCmp({
  ...
  methods: ['canDrop', 'select', 'overElement', 'outElement', 'nodeRefMap']
})
@Component({
  selector: 'aiao-tree',
  changeDetection: ChangeDetectionStrategy.OnPush,
