...
describe('lib', () => {
  ...
  describe('--unit-test-runner none', () => {
    it('should not generate test configuration', async () => {
      ...
      expect(workspaceJson.projects['my-lib'].architect.lint).toMatchInlineSnapshot(`
        Object {
          "builder": "@nrwl/linter:eslint",
          "options": Object {
  ...
  describe('buildable package', () => {
    it('should have a builder defined', async () => {
      ...
      expect(workspaceJson.projects['my-lib'].architect.build).toMatchInlineSnapshot(`
        Object {
  ...
  describe('--importPath', () => {
    it('should update the package.json & tsconfig with the given import path', async () => {
      ...
      expect(tsconfigJson.compilerOptions.paths[packageJson.name]).toBeDefined();
    });
    ...
    it('should fail if the same importPath has already been used', async () => {
      ...
      try {
        ...
        expect(e.message).toContain('You already have a library using the import path');
      }
  ...
  describe(`--babelJest`, () => {
    it('should use babel for jest', async () => {
      ...
      expect(tree.read(`libs/my-lib/jest.config.js`, 'utf-8')).toMatchInlineSnapshot(`
        "module.exports = {
          displayName: 'my-lib',
  ...
  describe('--js flag', () => {
    it('should generate js files instead of ts files', async () => {
      ...
      expect(readJson(tree, 'libs/my-lib/tsconfig.json').compilerOptions).toEqual({
        allowJs: true
      });
      expect(readJson(tree, 'libs/my-lib/tsconfig.lib.json').include).toEqual(['**/*.ts', '**/*.js']);
    ...
    it('should update root tsconfig.json with a js file path', async () => {
      ...
      const tsconfigJson = readJson(tree, '/tsconfig.base.json');
      expect(tsconfigJson.compilerOptions.paths['@proj/my-lib']).toEqual(['libs/my-lib/src/index.js']);
    });
    ...
    it('should update architect builder when --buildable', async () => {
      ...
      expect(workspaceJson.projects['my-lib'].architect.build.options.main).toEqual('libs/my-lib/src/index.js');
    });
    ...
    it('should generate js files for nested libs as well', async () => {
      ...
      expect(tree.exists('libs/my-dir/my-lib/src/lib/my-dir-my-lib.js')).toBeTruthy();
      expect(tree.exists('libs/my-dir/my-lib/src/lib/my-dir-my-lib.spec.js')).toBeTruthy();
    });
  });
  ...
  describe('--pascalCaseFiles', () => {
    ...
    it('should generate files with upper case names for nested libs as well', async () => {
      ...
      expect(tree.exists('libs/my-dir/my-lib/src/lib/MyDirMyLib.ts')).toBeTruthy();
      expect(tree.exists('libs/my-dir/my-lib/src/lib/MyDirMyLib.spec.ts')).toBeTruthy();
      expect(tree.exists('libs/my-dir/my-lib/src/lib/my-dir-my-lib.ts')).toBeFalsy();
      expect(tree.exists('libs/my-dir/my-lib/src/lib/my-dir-my-lib.spec.ts')).toBeFalsy();
    });
  });
});
